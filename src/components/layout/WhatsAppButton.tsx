...
const WHATSAPP_URL = 'https://wa.me/5511993443369';

// Fica logo acima do ScrollToTopButton (48px em right-8/bottom-8):
// right 28px centraliza os 56px sobre os 48px da seta; bottom 92px
// deixa 12px de respiro acima dela.
