...
/**
 * Topo da página de Filmes — mesmo padrão da página de Imagens.
 *
 * A imagem manda: banner com paralaxe, trilha Home › Serviço e o título
 * vivendo dentro dele. As categorias não moram mais aqui — viraram os
 * filtros em texto acima das seções (VideoFilterBar).
 */
