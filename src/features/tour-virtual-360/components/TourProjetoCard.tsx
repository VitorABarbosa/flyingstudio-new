...
/**
 * Card de projeto. Clicar carrega o tour dele na seção de baixo, então é um
 * botão de verdade — não um card decorativo com `onClick` pendurado.
 */
export default function TourProjetoCard({
  client,
  project,
  image,
  isActive = false,
