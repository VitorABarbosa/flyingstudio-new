...
const WHATSAPP_CTA_URL =
  'https://wa.me/5511993443369?text=Ol%C3%A1%2C%20vim%20pelo%20site%20da%20Flying%20Studio%20e%20quero%20uma%20demonstra%C3%A7%C3%A3o%20do%20Tour%20Virtual%20360%C2%B0!';
...
/**
 * Fecho da página — mesmo modelo do D.sbrave e de Aplicativos: uma afirmação
 * curta e o botão de demonstração.
 */
export default function TourDemoCta() {
  const t = useTranslations('Tour360Page.demo');
