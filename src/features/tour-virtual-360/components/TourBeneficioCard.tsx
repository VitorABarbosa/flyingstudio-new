 ...
 * texto de exemplo e cortava a descrição real. Agora a altura vem do conteúdo,
 * e o `h-full` no grid mantém os quatro alinhados.
 */
export default function TourBeneficioCard({
  icon,
  title,
  description,
}: TourBeneficioCardProps) {
  return (
