...
/**
 * Topo da página de Aplicativos — mesmo modelo do D.sbrave: banner com
 * paralaxe, eyebrow e só o título. O produto rodando aparece na seção
 * seguinte (FlyAppExplainerSection), no laptop ao lado das informações.
 */
