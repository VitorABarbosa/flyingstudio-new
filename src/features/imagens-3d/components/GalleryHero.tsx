 ...
 *
 * A imagem manda: banner alto com paralaxe e o título vivendo dentro dele.
 * As categorias não moram mais aqui — viraram os filtros em texto no
 * cabeçalho da galeria (GalleryFilterBar).
 */
